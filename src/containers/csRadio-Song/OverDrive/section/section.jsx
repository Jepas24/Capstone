...
const OverDriveSection = () => {
  const [posts, setPosts] = useState({})
  useEffect(() =>{
    let isMounted = true;
    axios.get('https://api.codetabs.com/v1/proxy?quest=https://radio.cloudstaff.com/apis/playlist/overdrive')
    .then(res => {
      if(isMounted ){
  ...
  return (
    <div className='csRadio__section'>
        ...
        <AudioPlayer
            ...
            src="https://cs-streamradio.cloudstaff.com:8020/cloudoverdrive.mp3"
...
export default OverDriveSection